...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="/mybatis">
...
<div class="modal fade" id="log-in">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- 
				=> http://localhost/mybatis/login.me(서블릿 매핑값)
			...
			-->
				...
				<form action="${ pageContext.request.contextPath }/login.me" name="sign-in" method="post" id="signInForm"
					...
					<table style="cellpadding: 0; cellspacing: 0; margin: 0 auto; width: 100%">
						...
						<tr>
							<td><input type="text" name="member-id" id="signInId"
						...
						<tr>
							<td><input type="password" size="17" maxlength="20" id="signInPw"
								name="member-pwd" class="form-control tooltipstered" 
